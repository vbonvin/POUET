...
class Ui_POUET(object):
    def setupUi(self, POUET):
        ...
        self.saveExportAddLayout = QtWidgets.QHBoxLayout()
        self.saveExportAddLayout.setObjectName("saveExportAddLayout")
        self.saveObs = QtWidgets.QPushButton(self.obs)
        self.saveObs.setObjectName("saveObs")
        self.saveExportAddLayout.addWidget(self.saveObs)
        ...
        self.saveExportAddLayout.addWidget(self.saveObsLabel)
        self.saveObsPath = QtWidgets.QLineEdit(self.obs)
        self.saveObsPath.setObjectName("saveObsPath")
        self.saveExportAddLayout.addWidget(self.saveObsPath)
        ...
        self.saveExportAddLayout.addWidget(self.toggleSaveObsOverwrite)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.saveExportAddLayout.addItem(spacerItem7)
        self.printNamesObs = QtWidgets.QPushButton(self.obs)
        self.printNamesObs.setObjectName("printNamesObs")
        self.saveExportAddLayout.addWidget(self.printNamesObs)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.saveExportAddLayout.addItem(spacerItem8)
        self.addNewObs = QtWidgets.QPushButton(self.obs)
        self.addNewObs.setObjectName("addNewObs")
        self.saveExportAddLayout.addWidget(self.addNewObs)
        self.verticalLayout_2.addLayout(self.saveExportAddLayout)
    ...
    def retranslateUi(self, POUET):
        ...
        self.addNewObs.setText(_translate("POUET", "Add new target"))
