...
class MyWindow(QtGui.QWidget):
	...
	def on_threadSample_newSample(self):
		...
		CS=self.matplotlibWidget.axis.contourf(ra_g,dec_g,sep,v, cmap=plt.get_cmap("RdYlGn"))
		t= np.arange(self.moon_cutoff, 190, 10)
		cb = self.matplotlibWidget.figure.colorbar(CS,ax=self.matplotlibWidget.axis,cax=self.matplotlibWidget.cax, ticks=t)
		cb.set_label("Angle to the Moon")
